...
scoreboard players operation #right_click_detector_ID sourcecraft.temp = @s plushpets.ID

#find plush pet
execute as @e[type=minecraft:armor_stand,tag=plushpets.plush_pet] if score @s plushpets.ID = #right_click_detector_ID sourcecraft.temp run tag @s add plushpets.plush_pet_found
