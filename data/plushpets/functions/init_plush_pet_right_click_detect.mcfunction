...
execute as @e[type=minecraft:villager,tag=plushpets.right_click_detector_plush_pet] if score @s plushpets.ID = #pet_ID plushpets.temp run tag @s add plushpets.right_click_detector_found
...
execute unless entity @e[type=minecraft:villager,tag=plushpets.right_click_detector_found,limit=1] run scoreboard players operation @e[type=minecraft:villager,tag=plushpets.right_click_detector_init] plushpets.ID = #pet_ID plushpets.temp
