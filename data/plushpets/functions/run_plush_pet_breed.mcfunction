...
function plushpets:determine_plush_egg_type

#determine xp
scoreboard players set #RNG plushpets.min 1
scoreboard players set #RNG plushpets.max 7
...
execute store result entity @e[type=minecraft:experience_orb,tag=plushpets.xp_init,limit=1] Value short 1 run scoreboard players get #plushpets:rng.output plushpets.temp
...
schedule function plushpets:schedule_plush_egg_hatch 12000t append
...
schedule function plushpets:schedule_end_love_cooldown 6000t append